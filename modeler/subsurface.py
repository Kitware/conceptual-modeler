...
class SubSurface:
    ...
    def create_xp2d(self):
        self._xp2d = gp.plot_2d(self._geo_model, figsize=(5.6, 3.36), dpi=192, legend=False, cell_number=[0], direction=['x'], show_data=False, show=False)
        plt.xlabel('')
        plt.ylabel('')
        plt.title('')
    ...
    def create_yp2d(self): 
        self._yp2d = gp.plot_2d(self._geo_model, figsize=(5.6, 3.36), dpi=192, legend=False, cell_number=[0], direction=['y'], show_data=False, show=False)
        plt.xlabel('')
        plt.ylabel('')
        plt.title('')
    ...
    def create_zp2d(self):
        self._zp2d = gp.plot_2d(self._geo_model, figsize=(5.6, 3.36), dpi=192, legend=False, cell_number=[0], direction=['z'], show_data=False, show=False)
        plt.xlabel('')
        plt.ylabel('')
        plt.title('')
    ...
    def update_xfig(self, **kwargs):
        ...
        self._xp2d = gp.plot_2d(self._geo_model, **kwargs, legend=False, direction=['x'], show_data=False, show=False)
        plt.xlabel('')
        plt.ylabel('')
        plt.title('')
        self._xp2d.fig.tight_layout(pad=0.001)
    ...
    def update_yfig(self, **kwargs):
        ...
        self._yp2d = gp.plot_2d(self._geo_model, **kwargs, legend=False, direction=['y'], show_data=False, show=False)
        plt.xlabel('')
        plt.ylabel('')
        plt.title('')
        self._yp2d.fig.tight_layout(pad=0.001)
    ...
    def update_zfig(self, **kwargs):
        ...
        self._zp2d = gp.plot_2d(self._geo_model, **kwargs, legend=False, direction=['z'], show_data=False, show=False)
        plt.xlabel('')
        plt.ylabel('')
        plt.title('')
        self._zp2d.fig.tight_layout(pad=0.001)
